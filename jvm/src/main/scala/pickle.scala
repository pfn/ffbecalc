...
object Pickler {
  ...
  def main(args: Array[String]): Unit = {
    ...
    asserteq(equips.find(_.id == 301001500), "Some(EquipIndex(Swordbreaker,301001500,item_10110.png,false,1,WeaponVariance(0.95,1.05),0,List(206170),1,ATK+43,None,List(IndexSkillInfo(206170,Crisis Evasion,true,ability_97.png,List(5% chance of evading physical attacks),List(),List(PassiveDodgeEffect(5,0))))))")
